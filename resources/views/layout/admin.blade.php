  ...
  <div class="min-h-screen flex">
        ...
        <ul class="space-y-1">
          ...
          <li>
            <a href="{{route('libros.index')}}"
              class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('libros.*') ? 'bg-blue-500/20 border border-blue-500/20' : 'hover:bg-white/10' }} transition">
              <span class="opacity-90">📚</span>
          ...
          <li>
            <a href="{{route('usuarios.index')}}"
              class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('usuarios.*') ? 'bg-blue-500/20 border border-blue-500/20' : 'hover:bg-white/10' }} transition">
              <span class="opacity-90">👥</span>
    ...
    <aside id="drawer"
      ...
      <nav class="px-3 py-4">
        <p class="px-3 text-[11px] tracking-wider text-white/50 uppercase mb-3">Menú</p>
        <ul class="space-y-1">
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition" href="{{ route('home') }}">🏠 Inicio</a></li>
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('libros.*') ? 'bg-blue-600 text-white' : 'hover:bg-white/10' }} transition" href="{{ route('libros.index') }}">📚 Libros</a></li>
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('categorias.*') ? 'bg-blue-600 text-white' : 'hover:bg-white/10' }} transition" href="{{ route('categorias.index') }}">🏷️ Categorías</a></li>
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('usuarios.*') ? 'bg-blue-600 text-white' : 'hover:bg-white/10' }} transition" href="{{ route('usuarios.index') }}">👥 Usuarios</a></li>
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl {{ request()->routeIs('prestamos.*') ? 'bg-blue-600 text-white' : 'hover:bg-white/10' }} transition" href="{{ route('prestamos.index') }}">🔁 Préstamos</a></li>
          <li class="pt-2"><a class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-red-500/15 transition" href="{{ route('logout') }}">🚪 Salir</a></li>
        </ul>
      </nav>
    </aside>
          ...
          <div class="h-16 flex items-center justify-between gap-4">
            ...
            <nav class="hidden md:flex items-center gap-2">
              <a href="{{ route('home') }}" class="px-3 py-2 rounded-xl text-sm font-medium {{ request()->routeIs('home') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100' }} transition">Inicio</a>
               <a href="{{ route('libros.index') }}" 
       class="px-3 py-2 rounded-xl text-sm font-medium {{ request()->routeIs('libros.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100' }} transition">
        Libros
    </a>
    <a href="{{ route('categorias.index') }}" 
       class="px-3 py-2 rounded-xl text-sm font-medium {{ request()->routeIs('categorias.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100' }} transition">
        Categorías
    </a>
    <a href="{{ route('usuarios.index') }}" 
       class="px-3 py-2 rounded-xl text-sm font-medium {{ request()->routeIs('usuarios.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100' }} transition">
        Usuarios
    </a>
    <a href="{{ route('prestamos.index') }}" 
       class="px-3 py-2 rounded-xl text-sm font-medium {{ request()->routeIs('prestamos.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100' }} transition">
        Préstamos
    </a>
    <a href="{{ route('logout') }}" 

              ...
              <table class="min-w-full text-sm">
                ...
                <tbody class="divide-y divide-slate-200">
                  ...
                  <tr class="hover:bg-slate-50/80 transition">
                    ...
                    <td class="px-4 sm:px-6 py-4">
                      <a href="{{ route('libros.edit', $libro->id) }}" class="text-blue-700 font-semibold hover:underline">Editar</a>
                      <a href="{{ route('libros.destroy', $libro->id) }}" class="text-rose-600 font-semibold hover:underline ml-3">Eliminar</a>
                    </td>
                  </tr>
                  @endforeach
                </tbody>

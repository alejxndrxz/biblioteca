        ...
        <div class="container mx-auto px-5 lg:px-8">
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex space-x-8 text-lg font-medium">
                    ...
                    <a href="#" class="bg-amber-600 text-white px-5 py-2 rounded-full hover:bg-amber-700 transition flex items-center space-x-1">
            ...
            <div id="mobileMenu" class="mobile-menu md:hidden bg-white pb-5 px-2">
                <nav class="flex flex-col space-y-4 text-base font-medium border-t pt-5">
                    ...
                    <a href="#" class="bg-amber-600 text-white py-3 px-3 rounded-md flex items-center justify-center space-x-2 mt-2">
                        <i class="fas fa-sign-in-alt"></i>

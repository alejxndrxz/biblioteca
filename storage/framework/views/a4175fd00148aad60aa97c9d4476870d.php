            ...
            <div class="flex justify-between items-center py-4">
                ...
                <nav class="hidden md:flex space-x-8 text-lg font-medium">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <span class="text-gray-700 font-medium">Hola, <?php echo e(auth()->user()->name); ?></span>
                        <a href="<?php echo e(route('logout')); ?>" class="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-red-700 transition flex items-center space-x-1">
                            <i class="fas fa-sign-out-alt"></i>
                            <span>Salir</span>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="bg-amber-600 text-white px-5 py-2 rounded-full hover:bg-amber-700 transition flex items-center space-x-1">
                ...
                <nav class="flex flex-col space-y-4 text-base font-medium border-t pt-5">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <div class="text-gray-700 py-2 px-3 font-medium">
                            <i class="fas fa-user mr-3"></i> Hola, <?php echo e(auth()->user()->name); ?>

                        </div>
                        <a href="<?php echo e(route('logout')); ?>" class="bg-red-600 text-white py-3 px-3 rounded-md flex items-center justify-center space-x-2 mt-2 w-full">
                            <i class="fas fa-sign-out-alt"></i>
                            <span>Cerrar sesión</span>
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="bg-amber-600 text-white py-3 px-3 rounded-md flex items-center justify-center space-x-2 mt-2">
                            <i class="fas fa-sign-in-alt"></i>
...
<?php /**PATH C:\Users\danie\Herd\biblioteca\resources\views/welcome.blade.php ENDPATH**/ ?>
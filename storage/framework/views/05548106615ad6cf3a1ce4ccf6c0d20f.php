    ...
    <table class="w-full table-auto">
      ...
      <tbody>
        ...
        <tr class="hover:bg-gray-50 transition-colors">
          <td class="border-t px-4 py-2"><?php echo e($categoria->id); ?></td>
          <td class="border-t px-4 py-2 font-medium"><?php echo e($categoria->nombre); ?></td>
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danie\Herd\biblioteca\resources\views/categorias/index.blade.php ENDPATH**/ ?>
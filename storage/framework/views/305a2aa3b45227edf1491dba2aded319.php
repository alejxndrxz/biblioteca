  ...
  <div class="min-h-screen flex">
        ...
        <ul class="space-y-1">
          <li>
            <a href="<?php echo e(route('home')); ?>"
              class="flex items-center gap-3 px-3 py-2 rounded-xl <?php echo e(request()->routeIs('home') ? 'bg-blue-500/20 border border-blue-500/20' : 'hover:bg-white/10'); ?> transition">
          ...
          <li>
            <a href="<?php echo e(route('libros.index')); ?>"
              class="flex items-center gap-3 px-3 py-2 rounded-xl <?php echo e(request()->routeIs('libros.*') ? 'bg-blue-500/20 border border-blue-500/20' : 'hover:bg-white/10'); ?> transition">
              <span class="opacity-90">📚</span>
          ...
          <li>
            <a href="<?php echo e(route('usuarios.index')); ?>"
              class="flex items-center gap-3 px-3 py-2 rounded-xl <?php echo e(request()->routeIs('usuarios.*') ? 'bg-blue-500/20 border border-blue-500/20' : 'hover:bg-white/10'); ?> transition">
              <span class="opacity-90">👥</span>
    ...
    <aside id="drawer"
      ...
      <nav class="px-3 py-4">
        <p class="px-3 text-[11px] tracking-wider text-white/50 uppercase mb-3">Menú</p>
        <ul class="space-y-1">
          <li><a class="flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-white/10 transition" href="<?php echo e(route('home')); ?>">🏠 Inicio</a></li>
...
<?php /**PATH C:\Users\danie\Herd\biblioteca\resources\views/layout/admin.blade.php ENDPATH**/ ?>
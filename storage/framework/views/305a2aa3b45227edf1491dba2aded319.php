        ...
        <div class="px-4 sm:px-6 lg:px-8">
          <div class="h-16 flex items-center justify-between gap-4">
            ...
            <nav class="hidden md:flex items-center gap-2">
              ...
              <a href="<?php echo e(route('categorias.index')); ?>" class="px-3 py-2 rounded-xl text-sm font-medium <?php echo e(request()->routeIs('categorias.*') ? 'bg-blue-600 text-white hover:bg-blue-700' : 'text-slate-700 hover:bg-slate-100'); ?> transition">Categorías</a>

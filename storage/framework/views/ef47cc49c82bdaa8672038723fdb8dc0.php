...
<main class="flex-1">
  <section class="px-4 sm:px-6 lg:px-8 py-6">
    ...
    <div class="text-sm text-slate-500 mb-3">
      <a href="<?php echo e(route('home')); ?>" class="hover:text-slate-700">Inicio</a>
      ...
      <article class="bg-white rounded-2xl border border-slate-200 shadow-sm p-5">
        <div class="flex items-start justify-between gap-4">
          <div>
            ...
            <p class="text-2xl font-bold mt-1"><?php echo e(count($libros)); ?></p>
    ...
    <section class="bg-white rounded-2xl border border-slate-200 shadow-sm overflow-hidden">
      <header class="p-4 sm:p-5 border-b border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
          ...
          <a href="<?php echo e(route('libros.create')); ?>" class="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 transition">
          ...
          <tbody class="divide-y divide-slate-200">
            ...
            <tr class="hover:bg-slate-50/80 transition">
              ...
              <td class="px-4 sm:px-6 py-4">
                ...
                <form action="<?php echo e(route('libros.destroy', $libro->id)); ?>" 
...
<?php echo $__env->make('layout.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\danie\Herd\biblioteca\resources\views/libros/index.blade.php ENDPATH**/ ?>